...
export function Icon({ className = "", icon, ...props }: { [K in Exclude<IconType, "key" | "style">]?: boolean } & { className?: string, icon?: IconType, key?: Key | null | boolean, style?: CSSProperties | boolean }): ReactElement {
...
export const ICONS: MaterialSymbol[] = [
  "123",
  "360",
  "10k",
  "10mp",
